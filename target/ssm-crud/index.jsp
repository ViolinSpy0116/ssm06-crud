...
<!-- 新增部门模态框 -->
<div class="modal fade" id="deptAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabelDept">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
                <h4 class="modal-title" id="myModalLabelDept">Add Dept</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="empName_add_input" class="col-sm-2 control-label">deptId</label>
                        <div class="col-sm-10">
                            <input type="text" name="deptId" class="form-control" id="deptId_add_input"
                                   placeholder="deptId">
                            <span class="help-block"></span>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="dept_save_btn">Save changes</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-8">
            ...
            <button class="btn btn-primary" id="dept_add_one_btn">新增部门</button>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function build_emps_table(result) {
        ...
        $.each(emps, function (index, item) {
            ...
            var genderTd = $("<td></td>").append(item.gender == 'M' ? "男" : "女").append("<td></td>");
     ...
     * 新增部门按钮点击事件
     */
    $("#dept_add_one_btn").click(function () {
